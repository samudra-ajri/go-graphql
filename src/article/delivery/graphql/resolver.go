...
import (
	...
	"github.com/samudra-ajri/go-graphql/src/article/repository"
	"github.com/samudra-ajri/go-graphql/src/domain"
)
...
type resolver struct {
	articleService domain.ArticleUsecase
}
...
func NewResolver(articleService domain.ArticleUsecase) Resolver {
	return &resolver{
